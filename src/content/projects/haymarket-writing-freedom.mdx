...
The site is fully editable with a customized [Sanity content management dashboard](https://www.sanity.io/). Reusable content schemas means site editors can easily add new fellows as the programs grows each year.
