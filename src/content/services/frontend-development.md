...
tagline: Building <span class="text-gradient">resilient</span>, <span class="text-gradient">future-proof</span> websites
taglinePlain: Building resilient, future-proof websites
preview:
  title: Effective Frontend Development
...
In all things web development, [my philosophy](/process) is to stay simple until you need to get complex. But even when complexity is called for, I try to approach it in the simplest way possible.
